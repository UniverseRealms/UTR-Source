...
public class MarketCreateOfferScreen extends Sprite
   {
      ...
      public function MarketCreateOfferScreen()
      {
         ...
         if(!offerMask)
         {
            ...
            offerMask.graphics.drawRect(0,-43,700,480);
            offerMask.graphics.endFill();
         }
         addChild(offerMask);
         this.offerHolder = new Sprite();
          this.offerHolder.y -= 43;
         ...
         this.addOfferButton.x = 405;
         //this.offerHolder.addChild(this.addOfferButton);
         this.scrollBar = new Scrollbar(16,471);
         this.scrollBar.y -= 35;
         this.scrollBar.x = 510;
      ...
      {
          this.offerHolder.y = -this.scrollBar.pos() * (this.offerHolder.height + 12) - HEIGHT;
      }
   }
}
...
class OfferEntry extends Sprite
{
    ...
    public static const WIDTH:int = 517;
   ...
   function OfferEntry()
   {
      ...
      graphics.drawRect(0,0,WIDTH,HEIGHT);
      graphics.endFill();
      graphics.lineStyle(1,0x4D2156,1);
      graphics.drawRect(0,0,WIDTH,HEIGHT);
      graphics.lineStyle();
