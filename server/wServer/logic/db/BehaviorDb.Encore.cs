        ...
        .Init("Puppet Master v2",
            new State(
                ...
                new State("7",
                    ...
                    new State("11",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 7, 10, 4, 0, coolDown: 400),
                        new TimedTransition(300, "12")
                        ),
                    new State("12",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 13, 10, 4, 0, coolDown: 400),
                        new TimedTransition(300, "13")
                        ),
                    new State("13",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 19, 10, 4, 0, coolDown: 400),
                        new TimedTransition(300, "14")
                        ),
                    new State("14",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 7, 10, 4, 180, coolDown: 400),
                        new TimedTransition(300, "15")
                        ),
                    new State("15",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 13, 10, 4, 180, coolDown: 400),
                        new TimedTransition(300, "16")
                        ),
                    new State("16",
                        new HpLessTransition(.9, "17"),
                        new Shoot(20, 19, 10, 4, 180, coolDown: 400),
                    ...
                    new State("28",
                        ...
                        new Shoot(20, 12, 360 / 12, 1, 45, coolDown: 400),
                        new Shoot(20, 1, 0, 4, coolDown: 500, predictive: 0.09),
                        new State("29",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 1, 0, 2, 0, coolDown: 400),
                            new TimedTransition(200, "30")
                            ),
                        new State("30",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 3, 8, 2, 0, coolDown: 400),
                            new TimedTransition(200, "31")
                            ),
                        new State("31",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 5, 8, 2, 0, coolDown: 400),
                            new TimedTransition(200, "32")
                            ),
                        new State("32",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 7, 8, 2, 0, coolDown: 400),
                            new TimedTransition(200, "33")
                            ),
                        new State("33",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 9, 8, 2, 0, coolDown: 400),
                            new TimedTransition(2000, "34")
                            ),
                        new State("34",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 1, 0, 2, 90, coolDown: 400),
                            new TimedTransition(200, "35")
                            ),
                        new State("35",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 3, 8, 2, 90, coolDown: 400),
                            new TimedTransition(200, "36")
                            ),
                        new State("36",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 5, 8, 2, 90, coolDown: 400),
                            new TimedTransition(200, "37")
                            ),
                        new State("37",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 7, 8, 2, 90, coolDown: 400),
                            new TimedTransition(200, "38")
                            ),
                        new State("38",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 9, 8, 2, 90, coolDown: 400),
                            new TimedTransition(2000, "39")
                            ),
                        new State("39",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 1, 0, 2, 180, coolDown: 400),
                            new TimedTransition(200, "40")
                            ),
                        new State("40",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 3, 8, 2, 180, coolDown: 400),
                            new TimedTransition(200, "41")
                            ),
                        new State("41",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 5, 8, 2, 180, coolDown: 400),
                            new TimedTransition(200, "42")
                            ),
                        new State("42",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 7, 8, 2, 180, coolDown: 400),
                            new TimedTransition(200, "43")
                            ),
                        new State("43",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 9, 8, 2, 180, coolDown: 400),
                            new TimedTransition(2000, "44")
                            ),
                        new State("44",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 1, 0, 2, 270, coolDown: 400),
                            new TimedTransition(200, "45")
                            ),
                        new State("45",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 3, 8, 2, 270, coolDown: 400),
                            new TimedTransition(200, "46")
                            ),
                        new State("46",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 5, 8, 2, 270, coolDown: 400),
                            new TimedTransition(200, "47")
                            ),
                        new State("47",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 7, 8, 2, 270, coolDown: 400),
                            new TimedTransition(200, "48")
                            ),
                        new State("48",
                            new HpLessTransition(.05, "49"),
                            new Shoot(25, 9, 8, 2, 270, coolDown: 400),
                 ...
                 new Threshold(0.01,
                    new ItemLoot("The Subtle Knife", 0.02),
                    new ItemLoot("Misty Cloak", 0.002),
                    new ItemLoot("Prism of Deceit", 0.0067),
                    ...
                    new ItemLoot("Puppet Master's Encore Key", 0.005),
                    new ItemLoot("Rusted Leather Hide", 0.00143),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Funny Pet Stone", 0.001)
                )
            );
    }
}