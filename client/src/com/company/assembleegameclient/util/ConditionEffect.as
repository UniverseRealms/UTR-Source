...
public class ConditionEffect {
    ...
    public static const WEAK_IMMUNE:uint = 64;
    public static const BLEEDING_IMMUNE:uint = 65;
    ...
    public static const WEAK_IMMUNE_BIT:uint = (1 << (WEAK_IMMUNE - NEW_CON_THREASHOLD));
    public static const BLEEDING_IMMUNE_BIT:uint = (1 << (BLEEDING_IMMUNE - NEW_CON_THREASHOLD));
    ...
    public static var effects_:Vector.<ConditionEffect> =
            new <ConditionEffect>[
                ...
                new ConditionEffect("Weak Immune", WEAK_IMMUNE_BIT, null, TextKey.CONDITIONEFFECT_WEAK_IMMUNE),
                new ConditionEffect("Bleeding Immune", BLEEDING_IMMUNE_BIT, null, TextKey.CONDITIONEFFECT_BLEEDING_IMMUNE),
