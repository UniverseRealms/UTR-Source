        ...
        .Init("Sandstone Ancient",
                  new State(
                     new State("SpinShot",
                        ...
                        new Shoot(10, count: 2, projectileIndex: 3, predictive: 2.25, coolDown: 400),
                        new TimedTransition(4000, "healing"),
                        new State("1",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 90, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "2")
                        ),
                        new State("2",
                            new Shoot(0, projectileIndex: 2, count: 3, shootAngle: 90, fixedAngle: 60, coolDown: 400),
                            new TimedTransition(200, "3")
                        ),
                        new State("3",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 90, fixedAngle: 90, coolDown: 400),
                  ...
                  new State(
                    new State("fight",
                     ...
                     new State("Devouring",
                        ...
                        new Shoot(10, count: 16, projectileIndex: 1, coolDown: 400),
        ...
        .Init("Reincarnated Knight",
         ...
         .Init("Reincarnated Magician",
            new State(
                new State("swag",
                     new Follow(0.3, 8, 1),
                     new Shoot(8.4, count: 4, shootAngle: 8, projectileIndex: 0, coolDown: 400),
                     new TimedTransition(3250, "swag2")
                    ),
                new State("swag2",
                     new StayBack(0.3, 6),
                     new Shoot(8.4, count: 4, projectileIndex: 0, coolDown: 400),
                ...
                new State(
                   ...
                   new State("mainphase",
                    ...
                    new State("rush",
                        ...
                        new Prioritize(
                            new Follow(1, 8, 1, coolDown: 400),
                            new Wander(0.32)
                            ),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(40, count: 1, projectileIndex: 6, coolDown: 400),
                    ...
                    new State("heal",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(40, count: 4, shootAngle: 4, projectileIndex: 5, coolDown: 400),
                        new Shoot(40, count: 7, projectileIndex: 8, coolDown: 400),
