...
namespace wServer.realm
{
    internal class Oryx
    {
        ...
        {
            player.SendInfo("Welcome to Between The Ages!");
        ...
        private void SpawnEvent(string name, ISetPiece setpiece)
        {
            ...
            } while ((_world.Map[pt.X, pt.Y].Terrain < WmapTerrain.Mountains || _world.Map[pt.X, pt.Y].Terrain > WmapTerrain.Mountains) || !_world.IsPassable(pt.X, pt.Y, true) ||
        ...
        public void InitCloseRealm()
        {
            ...
            _world.Manager.Chat.Announce("Realm closing in 30 sec.", true); // Close realm
        ...
        private void CloseRealm()
        {
            ...
            _world.Timers.Add(new WorldTimer(5000, (w) => //Shake in ...
            {
        ...
        private void SendToCastle()
        {
            ...
            BroadcastMsg("COME MEET YOUR DOOM AT THE WALLS OF MY CASTLE!"); // Send to oryx
