package io.decagames.rotmg.ui.tabs
{
   ...
   public class UITabs extends Sprite
   {
      ...
      public function addTab(param1:UITab, param2:Boolean = false) : void
      {
         ...
         param1.y = !!this.borderlessMode?Number(Number(34)):Number(Number(56));
         if(param2)
         {
      ...
      private function updateTabButtonGraphicState(param1:TabButton, param2:int) : void
      {
         ...
         if(Math.abs(_loc3_ - param2) <= 1)
         {
            ...
            {
               param1.changeBitmap("tab_button_borderless_idle",new Point(0,!!this.borderlessMode?Number(Number(0)):Number(Number(TabButton.SELECTED_MARGIN))));
               param1.bitmap.alpha = 0;
            }
            else if(_loc3_ > param2)
            {
               param1.changeBitmap("tab_button_right_idle",new Point(0,!!this.borderlessMode?Number(Number(0)):Number(Number(TabButton.SELECTED_MARGIN))));
            }
            else
            {
               param1.changeBitmap("tab_button_left_idle",new Point(0,!!this.borderlessMode?Number(Number(0)):Number(Number(TabButton.SELECTED_MARGIN))));
            }
         }
      }
