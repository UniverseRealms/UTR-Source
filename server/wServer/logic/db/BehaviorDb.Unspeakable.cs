...
#region servant of the dark knight (first boss)
            .Init("UNP Servant of the Dark Knight",
                new State(
                    ...
                    new State("spawn",
                        new TossObject("UNP Sorcerer of the Unspeakable", 4, 0, coolDown: 9999999, count: 4, angleOffset: 90),
                        new TimedTransition(2000, "fight1")
                        )
                    ),
                new Threshold(0.01,
                    new ItemLoot("Jacket of Denial", 0.0067),
    ...
    #endregion servant of the dark knight (first boss)

#region the dark knight
            .Init("UNP The Dark Knight",
                new State(
                    ...
                    new State("fight2",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Shoot(10, count: 4, shootAngle: 4, projectileIndex: 0, coolDown: 400),
                    ...
                    new State("fight4",
                        ...
                        new Shoot(10, count: 32, shootAngle: 11.25, projectileIndex: 4, coolDown: 1750, fixedAngle: 0),
                    ...
                    new State("spawn",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new TossObject("UNP Stone Phantom Knight", 6, 0, coolDown: 9999999, count: 4, angleOffset: 90),
                    ...
                    new State("rush2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Taunt(1.00, "YOUR END IS NOW!"),
                        new Prioritize(
                            new Follow(1.1, 8, 1),
                            new Wander(0.75)
                            ),
                    ...
                    new State("rush3",
                        ...
                        new TossObject("UNP Sorcerer of the Unspeakable", 1, 0, coolDown: 9999999, count: 4, angleOffset: 90),
                ...
                new Threshold(0.01,
                    new ItemLoot("Ring of the Crest", 0.02),
                    new ItemLoot("Sworn Protector's Helm", 0.0067),
                    new ItemLoot("Rapier of Evisceration", 0.002),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.025),
                    new TierLoot(4, ItemType.Ring, 0.025),
                    new ItemLoot("The Unspeakable Key", 0.005),
                    new ItemLoot("Rusted Sword", 0.00112),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Knight Pet Stone", 0.001)
                    )
                );
#endregion the dark knight
    }
}