...
namespace common
{
    ...
    public class DbChar : RedisObject
    {
        ...
        {
            get => GetValue<int>("skillPoints");
            set => SetValue("skillPoints", value);
        }
        public int UsedSkillPoints
        {
            get => GetValue<int>("usedSkillPoints");
            set => SetValue("usedSkillPoints", value);
        }

        public int[] BoughtSkills
        {
            get => GetValue<int[]>("boughtSkills");
            set => SetValue("boughtSkills", value);
        }
    }
    ...
    public class DbGuild : RedisObject
    {
        ...
        public int MemberInviting
        {
            get => GetValue<int>("memberInviting");
            set => SetValue("memberInviting", value);
        }
