        ...
        private _ Spider_Den = () => Behav()
             ...
             .Init("Arachna the Spider Queen",
                 new State(
                     ...
                     new State("MakeWeb",
                         ...
                         new TossObject("Arachna Web Spoke 2", range: 10, angle: 300, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 3", range: 10, angle: 240, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 8", range: 6, angle: 240, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 4", range: 10, angle: 180, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 5", range: 10, angle: 120, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 9", range: 6, angle: 120, coolDown: 100000),
                         new TossObject("Arachna Web Spoke 6", range: 10, angle: 60, coolDown: 100000),
             ...
             .Init("Arachna Web Spoke 1",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 3, fixedAngle: 180, shootAngle: 60, coolDown: 400),
             ...
             .Init("Arachna Web Spoke 2",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 1, fixedAngle: 240, shootAngle: 60, coolDown: 400),
                     new EntityNotExistsTransition("Arachna the Spider Queen", 1000, "Die")
                     ),
                     new State("Die",
                         new Decay(0)
             ...
             .Init("Arachna Web Spoke 3",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 3, fixedAngle: 300, shootAngle: 60, coolDown: 400),
                     new EntityNotExistsTransition("Arachna the Spider Queen", 1000, "Die")
                     ),
                     new State("Die",
                         new Decay(0)
             ...
             .Init("Arachna Web Spoke 4",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 1, fixedAngle: 0, shootAngle: 60, coolDown: 400),
                     new EntityNotExistsTransition("Arachna the Spider Queen", 1000, "Die")
                     ),
                     new State("Die",
                         new Decay(0)
             ...
             .Init("Arachna Web Spoke 5",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 3, fixedAngle: 60, shootAngle: 60, coolDown: 400),
                     new EntityNotExistsTransition("Arachna the Spider Queen", 1000, "Die")
                     ),
                     new State("Die",
                         new Decay(0)
             ...
             .Init("Arachna Web Spoke 6",
                 new State(
                     new State("Attack",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Shoot(1, count: 1, fixedAngle: 120, shootAngle: 60, coolDown: 400),
                     new EntityNotExistsTransition("Arachna the Spider Queen", 1000, "Die")
                     ),
                     new State("Die",
                         new Decay(0)
