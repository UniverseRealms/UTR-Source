        ...
        .Init("md Janus the Doorwarden",
                new State(
                    ...
                    new State("ringattacks",
                        ...
                        new Shoot(10, 10, projectileIndex: 0, coolDown: 400),
                    ...
                    new State("UpDown",
                        new Shoot(10, count: 8, fixedAngle: 0, shootAngle: 6, projectileIndex: 1, coolDown: 400),
                        new Shoot(10, count: 8, fixedAngle: 180, shootAngle: 6, projectileIndex: 1, coolDown: 400),
                    ...
                    new State("warn2",
                     ...
                     new State("LeftRight",
                        new Shoot(10, count: 8, fixedAngle: 90, shootAngle: 6, projectileIndex: 1, coolDown: 400),
                        new Shoot(10, count: 8, fixedAngle: 270, shootAngle: 6, projectileIndex: 1, coolDown: 400),
                     ...
                     new State("ragetime",
                      new State("1",
                        ...
                        new Shoot(10, 10, projectileIndex: 0, coolDown: new Cooldown(400, 200)),
                        new TimedTransition(6000, "2")
                        ),
                      new State("2",
                        new StayBack(1, 6),
                        new Shoot(10, 10, projectileIndex: 0, coolDown: new Cooldown(400, 100)),
                        new TimedTransition(6000, "1")
                        )
                      )
                    ),
                new Threshold(0.02,
                    new ItemLoot("Bow of Janus rage", 0.08),
                    new ItemLoot("Eye of Janus", 0.08),
                    new ItemLoot("Key of Rage", 0.08),
                    new ItemLoot("Warden Armor", 0.08)
                )
            )
