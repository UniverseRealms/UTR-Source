...
public class GeneralProjectileComparison extends SlotComparison {
    ...
    private function addProjectileText():void {
        ...
        if (projXML.ConditionEffect.length() > 0) {
            ...
            for each(_local4 in projXML.ConditionEffect) {
                comparisonStringBuilder.pushParams(_local4.toString() + " for " + _local4.@duration + " seconds", {}, TooltipHelper.getOpenTag(16777103), TooltipHelper.getCloseTag());
            }
        }
