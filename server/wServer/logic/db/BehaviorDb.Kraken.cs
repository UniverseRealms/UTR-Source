        ...
        .Init("The Kraken",
                ...
                new State(
                    ...
                    new State("Stage2",
                        ...
                        new Taunt(.50, "SKREEE!"),
                        new Shoot(10, 1, projectileIndex: 0, fixedAngle: -30, coolDown: 400, coolDownOffset: 3000),
                        new Shoot(10, 1, projectileIndex: 0, fixedAngle: -150, coolDown: 400, coolDownOffset: 3000),
                   ...
                   new State("Stage5",
                    ...
                    new State("Stage8",
                        new Order(10, "Kraken Tentacle", "shoot"),
                        new Shoot(10, 1, projectileIndex: 1, coolDown: 400),
                ...
                new State(
                    ...
                    new State("Stage2A",
                        new Order(10, "Kraken Tentacle", "idle"),
                        new Taunt(.50, "..."),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 180, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 120, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 240, coolDown: 400),
                        new TimedTransition(1000, "Stage2B")
                        ),
                   new State("Stage2B",
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 200, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 140, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 260, coolDown: 400),
                        new TimedTransition(1000, "Stage2C")
                       ),
                   new State("Stage2C",
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 160, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 100, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 220, coolDown: 400),
             ...
             .Init("The Kraken C",
                new State(
                    ...
                    new State("Stage2A",
                        new Order(10, "Kraken Tentacle", "idle"),
                        new Taunt(.50, "..."),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 0, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 60, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 300, coolDown: 400),
                        new TimedTransition(1000, "Stage2B")
                        ),
                   new State("Stage2B",
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 20, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 80, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 320, coolDown: 400),
                        new TimedTransition(1000, "Stage2C")
                       ),
                   new State("Stage2C",
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 340, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 30, coolDown: 400),
                        new Shoot(10, 1, projectileIndex: 2, fixedAngle: 280, coolDown: 400),
                        new TimedTransition(1000, "Stage2A")
                       )
                   ),
                   new State("Stage3",
