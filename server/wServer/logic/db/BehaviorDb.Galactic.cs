...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("The Overseer",
                ...
                new Threshold(0.01,
                    new ItemLoot("Staff of Unknown Origins", 0.01),
                    new ItemLoot("Extraterrestrial Robe", 0.005),
        ...
        .Init("The Alien King",
                new State(
                    ...
                    new State("BlastAndBeFast",
                        ...
                        new Shoot(8.4, count: 4, shootAngle: 4, fixedAngle: 0, projectileIndex: 1, coolDown: 400),
                        new TimedTransition(3000, "Quadforce2")
                        ),
                        new State("Quadforce2",
                             new Shoot(8.4, count: 1, fixedAngle: 90, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 180, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 270, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 45, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 135, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 225, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 315, projectileIndex: 3, coolDown: 400),
                            new TimedTransition(2000, "Quadforce3")
                        ),
                        new State("Quadforce3",
                            new Shoot(8.4, count: 4, shootAngle: 4, fixedAngle: 90, projectileIndex: 1, coolDown: 400),
                            new TimedTransition(3000, "Quadforce4")
                        ),
                        new State("Quadforce4",
                            new Shoot(8.4, count: 1, fixedAngle: 0, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 180, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 270, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 45, projectileIndex: 3, coolDown: 400),
                             new Shoot(8.4, count: 1, fixedAngle: 135, projectileIndex: 3, coolDown: 400),
                        ...
                        new State("Quadforce41",
                            new Shoot(8.4, count: 4, shootAngle: 4, fixedAngle: 180, projectileIndex: 1, coolDown: 400),
                        ...
                        new State("Quadforce5",
                            new Shoot(8.4, count: 4, shootAngle: 4, fixedAngle: 270, projectileIndex: 1, coolDown: 400),
                ...
                new Threshold(0.01,
                    new ItemLoot("Ring of Galaxies", 0.01),
                    new ItemLoot("Exile's Scabbard", 0.005),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.025),
                    new TierLoot(4, ItemType.Ring, 0.025),
                    new ItemLoot("Galactic Plateau Key", 0.005),
                    new ItemLoot("Rusted Staff", 0.00112),
                    new ItemLoot("Eternal Essence", 0.0005),
                    new ItemLoot("Extraterrestrial Pet Stone", 0.001)
                )
            )
            ;
    }
