package io.decagames.rotmg.ui.tabs
{
   ...
   public class TabButton extends SliceScalingButton
   {
      ...
      public function TabButton(param1:String)
      {
         ...
         _loc2_.addMargin(0,this.buttonType == BORDERLESS?int(0):int(int(SELECTED_MARGIN)));
      ...
      public function set selected(param1:Boolean) : void
      {
         ...
         if(!this._selected)
         {
            ...
            changeBitmap(this.defaultBitmap,new Point(0,this.buttonType == BORDERLESS?Number(Number(0)):Number(Number(SELECTED_MARGIN))));
            bitmap.alpha = 0;
         }
         else
         {
            setLabelMargin(0,this.buttonType == BORDERLESS?int(0):int(2));
            DefaultLabelFormat.defaultActiveTab(this.label);
            changeBitmap(this.selectedBitmap,new Point(0,this.buttonType == BORDERLESS?Number(Number(0)):Number(Number(SELECTED_MARGIN))));
            bitmap.alpha = 1;
         }
         this.updateIndicatorPosition();
      }
