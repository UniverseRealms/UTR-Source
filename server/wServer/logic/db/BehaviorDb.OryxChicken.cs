            ...
            .Init("TestChicken 2",
             ...
             new ChangeSize(20, 100),
                    ...
                    new State("Phase One",
                        ...
                        new State("Phase Two",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new OrderOnce(99, "TestChicken Small", "Orbit"),
                            new Taunt("Cluck cluck cluck ... CLUCK!"),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 0, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 180, shootAngle: 15),
                            new TimedTransition(200, "1"),
                            new HpLessTransition(.600, "Static1")
                            ),
                        new State("1",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 30, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 210, shootAngle: 15),
                            new TimedTransition(200, "2"),
                            new HpLessTransition(.600, "Static1")
                            ),
                            new State("2",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 60, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 240, shootAngle: 15),
                            new TimedTransition(200, "3"),
                            new HpLessTransition(.600, "Static1")
                                ),
                            new State("3",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 90, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 270, shootAngle: 15),
                            new TimedTransition(200, "4"),
                            new HpLessTransition(.600, "Static1")
                                ),
                                new State("4",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 120, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 300, shootAngle: 15),
                            new TimedTransition(200, "5"),
                            new HpLessTransition(.600, "Static1")
                                    ),
                                new State("5",
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 150, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 330, shootAngle: 15),
                            ...
                            new Reproduce("TestChicken Small", 40, 5, coolDown: 4000),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 180, shootAngle: 15),
                            new Shoot(10, count: 5, projectileIndex: 0, coolDown: 400, fixedAngle: 360, angleOffset: 360, shootAngle: 15),
                            new TimedTransition(200, "Phase Two2"),
                            new HpLessTransition(.600, "Static1")
                                    ),
