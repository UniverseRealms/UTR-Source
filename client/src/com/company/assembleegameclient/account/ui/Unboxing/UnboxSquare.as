...
public class UnboxSquare extends Sprite {
    ...
    private function addIcon() : void {
        ...
        if (_local1.hasOwnProperty("Heroic")) {
            _local5 = 0x10d000;
        }
        if (_local1.hasOwnProperty("Ancestral")) {
            _local5 = 0x5080f0;
        }
        if (_local1.hasOwnProperty("Sacred")) {
            _local5 = 0xff9000;
        }
        if (_local1.hasOwnProperty("Eternal")) {
            _local5 = 0x8e7cc3;
        }
        if (_local1.hasOwnProperty("Divine")) {
            _local5 = 0xef04040;
        }
