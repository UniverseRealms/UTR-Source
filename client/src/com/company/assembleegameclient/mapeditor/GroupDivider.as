...
public class GroupDivider {
    ...
    public static function divideObjects():void {
        ...
        for each (_local12 in ObjectLibrary.xmlLibrary_) {
            ...
            if (!((((((((((_local12.hasOwnProperty("Item")) || (_local12.hasOwnProperty("Player")))) || ((_local12.Class == "Projectile")))) || ((_local12.Class == "PetSkin")))) || ((_local12.Class == "Pet")))) || ((((_local10.search("Spawner") >= 0)) && (!((_local14.isAdmin()) || (Player.rank >= 15))))))) {
                if (!((!((_local14.isAdmin()) || Player.rank >= 15)) && ((HIDE_OBJECTS_IDS.indexOf(_local10) >= 0)))) {
                    _local11 = false;
                    if (((_local12.hasOwnProperty("Class")) && (String(_local12.Class).match(/wall$/i)))) {
                        ...
                        if (_local12.hasOwnProperty("Model")) {
                            ...
                            if (_local12.hasOwnProperty("Enemy") || _local12.hasOwnProperty("Ally")) {
                                ...
                                if (((_local12.hasOwnProperty("Static")) && (!(_local12.hasOwnProperty("Price"))))) {
                                    ...
                                    if ((_local14.isAdmin()) || (Player.rank >= 15)) {
                                        _local7[_local9] = _local12;
                                    }
                                }
                            }
    ...
    public static function getCategoryByType(_arg1:int, _arg2:int):String {
        ...
        if ((_local3.isAdmin()) || (Player.rank >= 15)) {
