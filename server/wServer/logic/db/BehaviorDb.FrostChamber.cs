                ...
                new State(
                    ...
                    new State("ShieldCheck",
                     ...
                     new State("CenterPhase1",
                        ...
                        new State("Duoforce1",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "Duoforce2")
                        ),
                        new State("Duoforce2",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 15, coolDown: 400),
                            new TimedTransition(200, "Duoforce3")
                        ),
                        new State("Duoforce3",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 30, coolDown: 400),
                            new TimedTransition(200, "Duoforce4")
                        ),
                        new State("Duoforce4",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 45, coolDown: 400),
                            new TimedTransition(200, "Duoforce21")
                        ),
                         new State("Duoforce21",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 60, coolDown: 400),
                            new TimedTransition(200, "Duoforce23")
                        ),
                         new State("Duoforce23",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 75, coolDown: 400),
                            new TimedTransition(200, "Duoforce25")
                        ),
                         new State("Duoforce25",
                            new Shoot(0, projectileIndex: 3, count: 2, shootAngle: 180, fixedAngle: 90, coolDown: 400),
