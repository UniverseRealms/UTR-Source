...
public class HealingEffect extends ParticleEffect {
    ...
    public function HealingEffect(_arg1:GameObject, _color:uint) {
        this.go_ = _arg1;
        this.lastPart_ = 0;
        this.color = _color;
    }
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        if (_local3 > 500) {
            ...
            _local7 = new HealParticle(this.color, (Math.random() * 0.3), _local5, 1000, (0.1 + (Math.random() * 0.1)), this.go_, _local4, _local6);
