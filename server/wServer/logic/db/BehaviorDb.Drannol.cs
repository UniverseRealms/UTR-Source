...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Drannol = () => Behav()
           ...
           .Init("BD Spirit Orb Green",
            new State(
                ...
                new OrderOnDeath(9999, "Spiritorb Holder Default Green", "die"),
                new State("Main",
                    new State("idle",
                        new PlayerWithinTransition(1, "Collect")
                        ),
                    new State("Collect",
                        new Suicide()
                        )
            ...
            new State(
                ...
                new State("Main",
                    ...
                    new State("activate",
                        ...
                        new EntityExistsTransition("BD Lava Bat", 6, "Collect")
                        ),
                    new State("Collect",
                        new Suicide()
                        )
        ...
        .Init("Ultra Nagarith the Tormentor",
            ...
            new State(
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new OrderOnDeath(9999, "Spiritorb Holder Default Blue", "die"),
                new State("Main",
                    new State("idle",
                        new PlayerWithinTransition(1, "Collect")
                        ),
        ...
        .Init("BD Ultra Spirit Orb Blue",
            new State(
                ...
                new State("Main",
                    ...
                    new State("activate",
                        ...
                        new TossObject("BD Lava Bat", 4, 180, coolDown: 9999999),
                        new TossObject("BD Lava Bat", 4, 270, coolDown: 9999999),
                        new EntityExistsTransition("BD Lava Bat", 99999, "Collect")
                        ),
                    new State("Collect",
                        new Suicide()
                        )
            ...
            new State(
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new OrderOnDeath(9999, "Spiritorb Holder Default Purple", "die"),
                new State("Main",
                    new State("idle",
                        new PlayerWithinTransition(1, "Collect")
                        ),
        ...
        .Init("BD Ultra Spirit Orb Purple",
            ...
            new State(
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new OrderOnDeath(9999, "Spiritorb Holder Default Orange", "die"),
                new State("Main",
                    new State("idle",
                        new PlayerWithinTransition(1, "Collect")
                        ),
        ...
        .Init("BD Ultra Spirit Orb Orange",
            ...
            new State(
                new DropPortalOnDeath("Hunter Cave Portal", 1, 0),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("idle",
            ...
            new State(
                new DropPortalOnDeath("Ultra Hunter Cave Portal", 1, 0),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("idle",
                     new EntitiesNotExistsTransition(9999, "activate", "Spiritorb Holder Default Purple", "Spiritorb Holder Default Green", "Spiritorb Holder Default Blue", "Spiritorb Holder Default Orange")
                    ),
        ...
        .Init("BD Puzzling Green Activated",
         ...
         .Init("BD Puzzle 1 Controller",
            ...
            new State(
                ...
                new State("Main",
                    new State("first",
                        new TimedTransition(200, "idle")
                        ),
                    new State("idle",
                        new EnemyAOE(2.5, false, 100, 200, true, 0xFF0000),
                        new Suicide()
                        )
                    )
                )
        ...
        .Init("UltraDrannolTargetBurst",
            new State(
                ...
                new State("Main",
                    ...
                    new State("idle",
                        new EnemyAOE(2.5, false, 150, 300, true, 0xFF0000),
                        new Suicide()
                        )
                    )
                )
            ...
            new State(
                new State("Main",
                    ...
                    new Prioritize(
                        ...
                        new Shoot(10, count: 6, shootAngle: 6, projectileIndex: 0, coolDown: 400)
                        )
                )
            )
            ...
            new State(
                new State("Main",
                    ...
                    new Prioritize(
                        ...
                        new Shoot(10, count: 3, shootAngle: 4, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(2000, "fight3")
                        ),
                    new State("fight3",
                        new Wander(0.1),
                        new Shoot(10, count: 6, projectileIndex: 1, coolDown: 1000),
                        new Shoot(10, count: 2, shootAngle: 4, projectileIndex: 0, coolDown: 400),
            ...
            new State(
                new State("Main",
                    ...
                    new State("run",
                        ...
                        new Taunt("GRAAAAGH!"),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable, duration: 3),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                ...
                new State(
                   ...
                   new State("jump",
                       new Taunt(0.75, "Heheheh...", "Bloodshed is so... gorgeous..."),
                        ...
                        new Shoot(10, count: 8, shootAngle: 8, projectileIndex: 0, coolDown: 400),
                ...
                new State(
                   ...
                   new State("jump",
                       new Taunt(0.75, "Heheheh...", "Bloodshed is so... gorgeous..."),
                        new SetAltTexture(1),
                        new Charge(7, range: 16, coolDown: 1000),
                        new Shoot(10, count: 10, shootAngle: 8, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(3200, "Unreveal")
                        ),
                   new State("Unreveal",
                        new SetAltTexture(0, 1, 10, true),
        ...
        .Init("BD Ultra Berikao, the Dark Hunter HUNTING 2",
                ...
                new State(
                    new ScaleHP(0.25),
                    new DropPortalOnDeath("The Steps Portal", 1, 0),
        ...
        .Init("Ultra Revil, the Twisted Vanguard",
                new State(
                    new ScaleHP(0.3),
                    new DropPortalOnDeath("Ultra The Steps", 1, 0),
                    new ChangeMusicOnDeath("oldcity"),
                    new State("default",
                        new BackAndForth(0.3, 6),
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Revil's Revenge", 0.002)
                    )
            )
            ...
            .Init("BD Berikao, the Dark Hunter",
                new State(
                    new ScaleHP(0.25),
                    new DropPortalOnDeath("Twisted Trials Portal", 1, 0),
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new State("default",
        ...
        .Init("BD Ultra Berikao, the Dark Hunter",
                new State(
                    new ScaleHP(0.3),
                    new DropPortalOnDeath("Ultra Twisted Domain", 1, 0),
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new State("default",
                        new PlayerWithinTransition(8, "taunt1")
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Vial of Luck", 0.0125),
                    new ItemLoot("Vial of Restoration", 0.0125),
                    new ItemLoot("Bloodlust Star", 0.002),
                    new ItemLoot("Hunter's Hide", 0.002)
                    )
            )
        ...
        .Init("Ultra Scorching Wrath Run",
            ...
            new State(
                new DropPortalOnDeath("The Steps 2 Portal", 1, 0),
                new SetNoXP(),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("go1",
        ...
        .Init("BD Ultra Platform Helper",
            new State(
                new DropPortalOnDeath("Ultra The Steps 2", 1, 0),
                new SetNoXP(),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("go1",
                    new TimedTransition(36000, "go2")
        ...
        .Init("Ultra Scorching Wrath Real",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Vial of Luck", 0.0125),
                    new ItemLoot("Vial of Restoration", 0.0125),
                    new ItemLoot("Lin's robes", 0.002)
                    )
                    )
           .Init("Lin2",
            new State(
                new DropPortalOnDeath("Summoning Point Portal", 1, 0),
        ...
        .Init("UltraLin2",
            new State(
                new DropPortalOnDeath("Ultra Summoning Point", 1, 0),
            ...
            .Init("Drannol, the Eternal Beast",
                new State(
                    ...
                    new State(
                        ...
                        new State(
                            new OrderOnce(90, "Spiritorb Holder Sentry", "sentry1"),
                            new Shoot(20, count: 14, projectileIndex: 0, coolDown: 600),
                        new State(
                                new Shoot(1, count: 4, coolDown: 2000, projectileIndex: 4, fixedAngle: 90, rotateAngle: 10, coolDownOffset: 0, shootAngle: 90),
                                new Shoot(1, count: 8, coolDown: 10000, projectileIndex: 4, fixedAngle: 180, coolDownOffset: 4000, shootAngle: 45),
                    ...
                    new State("Return2",
                        new OrderOnce(90, "Spiritorb Holder Sentry", "idle"),
                        new MoveTo(1, 44, 40),
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                    ...
                    new State("DIE1",
                            ...
                            new OrderOnce(90, "Spiritorb Holder Sentry", "sentry2"),
                  ...
                  new State(
                   new DamageTakenTransition(200000, "ready1"),
                    new OrderOnce(90, "Spiritorb Holder Sentry", "sentry3"),
                    new State("f1",
                            new TimedTransition(200, "f2"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 0, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f2",
                            new TimedTransition(200, "f3"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 20, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f3",
                            new TimedTransition(200, "f4"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 40, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f4",
                            new TimedTransition(200, "f5"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 60, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f5",
                            new TimedTransition(200, "f6"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 80, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f6",
                            new TimedTransition(200, "f7"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 100, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f7",
                            new TimedTransition(200, "f8"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 120, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f8",
                            new TimedTransition(200, "f9"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 140, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f9",
                            new TimedTransition(200, "f10"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 160, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f10",
                            new TimedTransition(200, "f11"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 180, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f11",
                            new TimedTransition(200, "f12"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 200, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f12",
                            new TimedTransition(200, "f13"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 220, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f13",
                            new TimedTransition(200, "f15"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 240, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f15",
                            new TimedTransition(200, "f16"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 260, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f16",
                            new TimedTransition(200, "f17"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 280, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f17",
                            new TimedTransition(200, "f18"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 300, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f18",
                            new TimedTransition(200, "f19"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 320, projectileIndex: 3, coolDown: 400)
                            ),
                    new State("f19",
                            new TimedTransition(200, "f1"),
                            new Shoot(10, count: 2, shootAngle: 4, fixedAngle: 340, projectileIndex: 3, coolDown: 400)
                            )
                        ),
                    ...
                    new State(
                        new Reproduce("DrannolTarget", 40, 8, coolDown: 2000),
                ...
                new Threshold(0.005,
                    new OnlyOne(
                        ...
                        new ItemLoot("Godly Remnant", 0.002)
                        ),
                    new ItemLoot("Bloodstone of Enmity", 0.001),
                    new ItemLoot("Legrundy Essence", 0.0005),
                    new ItemLoot("Crimson Shard", 0.002),
                    ...
                    new ItemLoot("Large Eternal Fragment", 0.006),
                    new ItemLoot("Medium Eternal Fragment", 0.015),
        ...
        .Init("Ultra Drannol, the Eternal Beast",
                new State(
                    ...
                    new State(
                        new DamageTakenTransition(110000, "Return2"),
                        new State(
                            new OrderOnce(90, "Ultra Spiritorb Holder Sentry", "sentry1"),
                            new Shoot(20, count: 14, projectileIndex: 0, coolDown: 600),
                        new State(
                                new Shoot(1, count: 4, coolDown: 2000, projectileIndex: 4, fixedAngle: 90, rotateAngle: 10, coolDownOffset: 0, shootAngle: 90),
                                new Shoot(1, count: 8, coolDown: 10000, projectileIndex: 4, fixedAngle: 180, coolDownOffset: 4000, shootAngle: 45),
                    ...
                    new State("Return2",
                        new OrderOnce(90, "Ultra Spiritorb Holder Sentry", "idle"),
                        new MoveTo(1, 44, 40),
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new TimedTransition(6000, "DIE1")
                        ),
                    new State("DIE1",
                            new DamageTakenTransition(140000, "invulnerable"),
                            new OrderOnce(90, "Ultra Spiritorb Holder Sentry", "sentry2"),
                  ...
                  new State(
                   new DamageTakenTransition(200000, "ready1"),
                    new OrderOnce(90, "Ultra Spiritorb Holder Sentry", "sentry3"),
                    new State("f1",
                            new TimedTransition(200, "f2"),
                            new Shoot(10, count: 4, shootAngle: 90, fixedAngle: 0, projectileIndex: 3, coolDown: 400)
                            ),
                    ...
                    new State("attack1a",
                        new Order(90, "Ultra Scorching Wrath Helper", "spawn"),
                        new TossObject("Ultra Bastille Sorcerer", 10, angle: 270, coolDown: 9999999),
                        new TossObject("Ultra Bastille Sorcerer", 5, angle: 270, coolDown: 9999999),
                        new TossObject("Flaming Summon", 3, angle: 180, coolDown: 9999),
                        new TossObject("Flaming Summon", 3, angle: 0, coolDown: 9999),
                    ...
                    new State(
                        new Reproduce("UltraDrannolTarget", 40, 8, coolDown: 2000),
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Flesh-Ripper", 0.002),
                    new ItemLoot("Hell-Forged Silvermail", 0.002),
                    new ItemLoot("Jacket of Rebirth", 0.002),
                    new ItemLoot("Fragment of the Realm", 0.002)
                )
            )          
        ;
    }
