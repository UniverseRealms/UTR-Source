    ...
    partial class BehaviorDb
    {
        ...
        .Init("Wraith of Fear",
            new State(
                ...
                new State("StunWave",
                     ...
                     new Shoot(10, count: 8, projectileIndex: 0, coolDown: 400),
        ...
        .Init("Dark Basement Warrior",
            new State(
                ...
                new State("fight2",
                     new Shoot(10, count: 1, projectileIndex: 0, coolDown: 400),
                     new Shoot(10, count: 1, projectileIndex: 0, coolDown: 400, coolDownOffset: 10),
        ...
        .Init("Living Garbage",
                new State(
                    new Wander(0.08),
                    new Shoot(8, count: 1, coolDown: new Cooldown(400, 600))
                    ),
        ...
        .Init("AB The Dark Sorcerer",
                new State(
                    ...
                    new State("FollowAndShoot",
                        ...
                        new Shoot(10, count: 3, shootAngle: 4, projectileIndex: 4, coolDown: 400),
                        new Shoot(10, count: 3, shootAngle: 4, projectileIndex: 4, coolDown: 400, coolDownOffset: 100),
                    ...
                    new State("Panic",
                        ...
                        new Shoot(10, count: 5, projectileIndex: 4, coolDown: 400),
                        new Shoot(10, count: 8, projectileIndex: 4, coolDown: 400, coolDownOffset: 200),
                   ...
                   new State(
                    ...
                    new State("BigShot",
                        ...
                        new Shoot(10, count: 6, projectileIndex: 3, coolDown: new Cooldown(400, 1000)),
                    ...
                    new State("BigShot2",
                        ...
                        new Shoot(10, count: 12, projectileIndex: 3, coolDown: new Cooldown(400, 1000)),
                ...
                new Threshold(0.01,
                    new ItemLoot("Silence Striker", 0.02),
                    new ItemLoot("Deliverance Wand", 0.0067),
                    new ItemLoot("Isolation Robe", 0.002),
                    ...
                    new ItemLoot("Abandoned Basement Key", 0.005),
                    new ItemLoot("Rusted Wand", 0.00143),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Cloaked Pet Stone", 0.001)
                )
            )
        .Init("AB Secret Chest",
                ...
                new MostDamagers(15,
                    new ItemLoot("Silence Striker", 0.005),
                    new ItemLoot("Deliverance Wand", 0.0025),
                    new ItemLoot("Isolation Robe", 0.001),
                    new ItemLoot("Potion of Dexterity", 0.25),
                    new ItemLoot("Potion of Restoration", 0.05),
                    ...
                    new ItemLoot("Rusted Wand", 0.000715),
