...
public class SorDisplayAir extends Sprite implements TooltipAble {

    public static const IMAGE_NAME:String = "lofiObjSc";
    public static const IMAGE_ID:int = 236;
    ...
    public function SorDisplayAir(_arg1:Player) {
        this.player = _arg1;
        this.hoverTooltipDelegate = new HoverTooltipDelegate();
        this.sorTexture = TextureRedrawer.redraw(AssetLibrary.getImageFromSet(IMAGE_NAME, IMAGE_ID), 64, true, 0);
        this.tooltip = new TextToolTip(0x363636, 0xFFFFFF, "Air Fragments", "" + player.airStorage_ + "/" + "2000", 200);
        super();
        mouseChildren = false;
