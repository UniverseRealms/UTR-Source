    ...
    partial class BehaviorDb
    {
        ...
        .Init("Vitalia",
            new State(
                ...
                new State("wait",
                    ...
                    new PlayerWithinTransition(10, "dialogue")
                    ),
                new State("dialogue",
                ...
                new State("fight",
                    ...
                    new TossObject("The Y-Eater", 4, 90, coolDown: 15000),
                    new TossObject("The Y-Eater", 4, 180, coolDown: 15000),
                    new TossObject("The Y-Eater", 4, 270, coolDown: 15000),
                    new TossObject("The Y-Eater", 4, 0, coolDown: 15000),
                    new HpLessTransition(0.9, "fight2")
                    ),
                new State("fight2",
                ...
                new State("fight2a",
                    ...
                    new HpLessTransition(0.65, "fight2b"),
                    new TimedTransition(15000, "fight2b")
                    ),
                new State("fight2b",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new Order(60, "Vitalia Vine Helper", "wait"),
                    new Taunt("Lets see if you can survive my minions!"),
                    new Shoot(40, 4, fixedAngle: 45, shootAngle: 90, projectileIndex: 11, coolDown: 400, coolDownOffset: 100),
                    new TossObject("Chomper", 5, 45, coolDown: 1000000),
                    new TossObject("Chomper", 5, 225, coolDown: 1000000),
                    new TossObject("Kwargnor the Devourer of worlds", 5, 135, coolDown: 1000000, coolDownOffset: 7000),
                    new TossObject("Kwargnor the Devourer of worlds", 5, 315, coolDown: 1000000, coolDownOffset: 7000),
                    new TimedTransition(10000, "waitfight2b")
                    ),
                new State("waitfight2b",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Shoot(40, 4, fixedAngle: 45, shootAngle: 90, projectileIndex: 11, coolDown: 400, coolDownOffset: 100),
                    new EntitiesNotExistsTransition(20, "fight2c", "Chomper", "Kwargnor the Devourer of worlds"),
                    new TimedTransition(15000, "fight2c")
                    ),
                new State("fight2c",
                    new Taunt("Fine! I didn't need them anyway"),
                    new Shoot(40, 4, fixedAngle: 45, shootAngle: 90, projectileIndex: 11, coolDown: 400, coolDownOffset: 100),
                    new Shoot(40, 4, shootAngle: 13, projectileIndex: 0, coolDown: 400),
                    new TossObject("The Y-Eater", 5, coolDown: 3000),
                    new HpLessTransition(0.55, "fight3")
                    ),
                new State("fight3",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new TimedTransition(1000, "purplelava")
                    ),
                new State("purplelava",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new ReplaceTile("CGarden Floor Dark", "CGarden Lava2", 80),
                    new TimedTransition(1500, "fight3b")
                    ),
                new State("fight3b",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new Taunt("AAAAAAAA"),
                     new TimedTransition(1500, "skinswitch")
                    ),
                ...
                new State("fight4a",
                    ...
                    new HpLessTransition(0.45, "fight5")
                    ),
                new State("fight4aa",
                    ...
                    new HpLessTransition(0.4, "fight5")
                    ),
                new State("fight4b",
                    new Follow(1, 10, 0),
                    new Shoot(40, 18, shootAngle: 20, projectileIndex: 13, coolDown: 3000),
                    ...
                    new HpLessTransition(0.3, "fight5")
                    ),
                new State("fight5",
                    new Orbit(1, 5, 10, "Vitalia Tracker"),
                    new Charge(3, 10, coolDown: 6000),
                    new Follow(2, 10, 1),
                    new TossObject("Vitalia Vine", 5, coolDown: 5000),
                    ...
                    new HpLessTransition(0.25, "fight5a")
                    ),
                new State("fight5a",
                    new Orbit(1, 5, 10, "Vitalia Tracker"),
                    new Charge(3, 10, coolDown: 6000),
                ...
                new State("fight5b",
                    ...
                    new TossObject("Vitalia Vine", 5, coolDown: 5000),
                    new TossObject("Chomper", 5, coolDown: 20000),
                    new TossObject("Kwargnor the Devourer of worlds", 5, coolDown: 20000),
                    new Shoot(40, 1, projectileIndex: 15, coolDown: 600),
                    new Shoot(40, 6, projectileIndex: 14, coolDown: 6000, coolDownOffset: 6000),
                    new Shoot(40, 3, fixedAngle: 45, projectileIndex: 7, coolDown: 1000, coolDownOffset: 250),
                    new Shoot(40, 3, fixedAngle: 135, projectileIndex: 8, coolDown: 1000, coolDownOffset: 500),
                ...
                new Threshold(0.01,
                    new ItemLoot("Nature's Gift", 0.02),
                    new ItemLoot("Chaotic Overgrowth", 0.0067),
                    new ItemLoot("Herbal Hide", 0.002),
                    ...
                    new ItemLoot("Rusted Bow", 0.00143),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Venus Pet Stone", 0.001)
                )
            )
        .Init("Vitalia Turret",
            new State(
                ...
                new State("diagonal",
                    new SetAltTexture(2),
                    new Shoot(40, 4, fixedAngle: 90, projectileIndex: 0, coolDown: 400),
        ...
        .Init("Vitalia Turret Helper",
            new State(
                ...
                new State("shoot",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Shoot(40, 2, fixedAngle: 90, shootAngle: 180, coolDown: 400),
        ...
        .Init("Granithia",
                new State(
                    ...
                    new State("fightb",
                        ...
                        new Shoot(50, 8, fixedAngle: 45, projectileIndex: 4, shootAngle: 45, coolDown: 400),
                        new HpLessTransition(0.85, "fight2"),
                        new TimedTransition(4500, "fightba")
                        ),
                    new State("fightba",
                        new Taunt("SWITCH!"),
                        new Shoot(50, 8, fixedAngle: 72, projectileIndex: 4, shootAngle: 45, coolDown: 400),
                        new HpLessTransition(0.85, "fight2"),
                    ...
                    new State("fight3",
                        ...
                        new TossObject("Servant of Granithia", 4, 90, coolDown: 99999),
                        new TossObject("Servant of Granithia", 4, 135, coolDown: 99999),
                        new TossObject("Servant of Granithia", 4, 45, coolDown: 99999),
                        new TossObject("Servant of Granithia", 4, 45, coolDown: 99999, coolDownOffset: 5000),
                        new TossObject("Servant of Granithia", 4, 0, coolDown: 99999, coolDownOffset: 5000),
                        new TossObject("Servant of Granithia", 4, 315, coolDown: 99999, coolDownOffset: 5000),
                        new TossObject("Servant of Granithia", 4, 315, coolDown: 99999, coolDownOffset: 10000),
                        new TossObject("Servant of Granithia", 4, 270, coolDown: 99999, coolDownOffset: 10000),
                        new TossObject("Servant of Granithia", 4, 225, coolDown: 99999, coolDownOffset: 10000),
                        new TossObject("Servant of Granithia", 4, 225, coolDown: 99999, coolDownOffset: 15000),
                        new TossObject("Servant of Granithia", 4, 180, coolDown: 99999, coolDownOffset: 15000),
                        new TossObject("Servant of Granithia", 4, 135, coolDown: 99999, coolDownOffset: 15000),
                        new TimedTransition(17000, "waitforservants")
                        ),
                    ...
                    new State("fight4a",
                     ...
                     new State("fight4b",
                        ...
                        new Shoot(50, 3, shootAngle: 12, projectileIndex: 0, coolDown: 950),
                        new Shoot(50, 8, shootAngle: 30, projectileIndex: 6, coolDown: 800),
                        new HpLessTransition(0.4, "fight4c")
                         ),
                     new State("fight4c",
                        new Follow(1, 10, 0),
                        new Grenade(3, 200, 5, coolDown: 1300),
                        new Shoot(50, 3, shootAngle: 12, projectileIndex: 0, coolDown: 950),
                        new Shoot(50, 8, shootAngle: 30, projectileIndex: 6, coolDown: 800),
                        new HpLessTransition(0.35, "fight4d")
                         ),
                     new State("fight4d",
                        new Follow(1.2, 10, 0),
                        new Grenade(3, 200, 5, coolDown: 1300),
                     ...
                     new State("fight5a",
                          ...
                          new HpLessTransition(0.05, "death"),
                          new TimedTransition(3000, "fight5b")
                         ),
                     new State("fight5b",
                         new Charge(1, 10),
                         ...
                         new HpLessTransition(0.05, "death"),
                         new TimedTransition(3000, "fight5c")
                         ),
                     new State("fight5c",
                         new Taunt("Try not to get flattened!"),
                         new Shoot(60, 1, projectileIndex: 3, predictive: 1, coolDown: 500),
                         new HpLessTransition(0.05, "death"),
                ...
                new Threshold(0.01,
                    new ItemLoot("Piercing Stone Wand", 0.02),
                    new ItemLoot("Robe of the Amber Acolyte", 0.0067),
                    new ItemLoot("Granite Amulet", 0.002),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.05),
                    new ItemLoot("Garden of Chaos Key", 0.005),
                    new ItemLoot("Rusted Ring", 0.00125),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Petrified Pet Stone", 0.001)
                            )
                        )
          .Init("Granithia Bomb",
                new State(
                    ...
                    new State("Explode",
                        new Shoot(100, projectileIndex: 0, count: 8, coolDown: 500),
                        new Suicide()
                        )
                    )
            )
        .Init("Servant of Granithia",
            new State(
                ...
                new State("uberattack",
                    ...
                    new Shoot(20, 9, shootAngle: 30, projectileIndex: 1, coolDown: 400, coolDownOffset: 250)
                    )
                )
            )
            ;
