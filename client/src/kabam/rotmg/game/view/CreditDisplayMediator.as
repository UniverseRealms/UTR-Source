...
public class CreditDisplayMediator extends Mediator {
    ...
    private function onCreditsChanged(_arg_1:int):void {
        this.view.draw(this.model.getCredits(), this.model.getFame(), this.model.getOnrane(), _arg_1);
    }
    ...
    private function onKantosChanged(_arg_1:int):void {
        this.view.draw(this.model.getCredits(), this.model.getFame(), this.model.getOnrane(), this.model.getOnrane(), _arg_1);
    }
