...
namespace wServer.realm.entities
{
    partial class Player
    {
        ...
        public void RequestTrade(string name)
        {
            ...
            {
                SendError("You are unable to trade due to your rank.");
                return;
            }*/
        ...
        private void CheckTradeTimeout()
        {
            ...
            foreach (var i in potentialTrader) newState.Add(new Tuple<Player, int>(i.Key, i.Value - (int)CoreConstant.worldTickMs));
