...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Asylum = () => Behav()
            .Init("BedlamGod",
                new State(
                    new DropPortalOnDeath("Abandoned Basement Portal", 1),
                    new ScaleHP(0.3),
                    new State("1",
                    ...
                    new State("7",
                        ...
                        new Wander(1),
                        new StayAbove(1, 1),
                        new Reproduce("Chaos Guardians", 0, 3, coolDown: 7000),
                        new Shoot(20, 1, projectileIndex: 0, predictive: 1, coolDown: 1000),
                        new Shoot(15, 3, 8, 1, predictive: 1, coolDown: 3000),
                        new Shoot(20, 8, 45, 3, 360, coolDown: 2000),
                        new Shoot(5, 2, 15, 2, predictive: 1, coolDown: 2000),
                    ...
                    new State("8",
                        new Reproduce("Chaos Guardians", 0, 3, coolDown: 5000),
                        new Shoot(20, 8, 45, 3, 360, coolDown: 2000),
                ...
                new Threshold(0.01,
                    new ItemLoot("Banner of the Underworld", 0.0084),
                    new ItemLoot("Armor of Calamity", 0.0046),
                   ...
                   .Init("Roach",
                        new State(
                            new Wander(3.5),
                            new Shoot(30, 1, projectileIndex: 0, predictive: 1, coolDown: 400)
                        )
            )
        .Init("AsylumStatue",
            new State(
         ...
         .Init("Asylum Wizzard",
                new State(
                    ...
                    new State("Summon_the_clones",
                        ...
                        new TossObject("Wizzard Clone", 5, 120, 100000),
                ...
                new Threshold(0.03,
                    new ItemLoot("Crystal Wand", 0.15),
                    new ItemLoot("Crystal Sword", 0.15)
                    )
            )
            .Init("Wizzard Clone",
                new State(
