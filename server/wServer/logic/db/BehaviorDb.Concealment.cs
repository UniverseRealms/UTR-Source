            ...
            .Init("The Dreadnought",
                new State(
                    ...
                    new State("fight1",
                        ...
                        new Shoot(10, count: 1, projectileIndex: 4, coolDown: 400),
                    ...
                    new State("fight6",
                        ...
                        new Shoot(10, count: 6, shootAngle: 16, projectileIndex: 0, coolDown: 400),
                    ...
                    new State("fight7",
                        ...
                        new Grenade(7, 85, range: 8, coolDown: 400),
                        new TimedTransition(4000, "fight1")
                            )
                        ),
                new Threshold(0.01,
                    new ItemLoot("Dreadnought's Spine", 0.01),
                    new ItemLoot("A Thief's Relief", 0.01),
                    new ItemLoot("Serpent's Skin Hide", 0.005),
                    ...
                    new ItemLoot("Concealment Key", 0.005),
                    new ItemLoot("Rusted Dagger", 0.00112),
                    new ItemLoot("Eternal Essence", 0.0005),
                    new ItemLoot("Golem Pet Stone", 0.001)
                )
            )
           ...
           .Init("Treasure Basilisk",
                ...
                new State("fight2",
                    new Taunt(1.00, "You want treasure, but I want your corpse.", "You shouldn't have found me. You'll now be found dead.", "I'd like to think you're just another snack.", "Pepper will go good with your flesh.", "The crunch of your bones will be quite satisfying to hear.", "I will rip your head off and drink the blood out of your body.", "Leave."),
                     new ConditionalEffect(ConditionEffectIndex.Armored),
                     new Shoot(8.4, count: 4, shootAngle: 6, projectileIndex: 0, coolDown: 400),
                ...
                new Threshold(0.01,
                    new ItemLoot("Dreadnought's Spine", 0.0034),
                    new ItemLoot("A Thief's Relief", 0.0034),
                    new ItemLoot("Serpent's Skin Hide", 0.004),
                    ...
                    new TierLoot(4, ItemType.Weapon, 0.0125),
                    new TierLoot(4, ItemType.Ability, 0.0125),
                    new TierLoot(4, ItemType.Armor, 0.0125),
                    new TierLoot(4, ItemType.Ring, 0.0125),
                    new ItemLoot("Rusted Dagger", 0.000374),
