    ...
    partial class BehaviorDb
    {
        private _ GhostKing = () => Behav()
            ...
            .Init("Actual Ghost King",
                ...
                new Threshold(0.18,
                new ItemLoot("Deathwanderer", 0.01),
                new ItemLoot("Sadist Blade of the King", 0.01),
                new ItemLoot("Armor of Masochism", 0.01),
                new ItemLoot("The Kings Crown", 0.01),
                new ItemLoot("Ring of Ashen Matrimony", 0.01)
                    ),
