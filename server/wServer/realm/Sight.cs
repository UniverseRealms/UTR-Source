    ...
    public class Sight
    {
        ...
        private static void InitSightRays()
        {
            ...
            while (currentAngle < EndAngle)
            {
                ...
                while (dist < Radius)
                {
                    var point = new IntPoint((int)(dist * Math.Cos(currentAngle)), (int)(dist * Math.Sin(currentAngle)));
        ...
        private static bool IsBlocking(WmapTile tile) => tile.ObjType != 0 && tile.ObjDesc != null && tile.ObjDesc.BlocksSight;
    }
}