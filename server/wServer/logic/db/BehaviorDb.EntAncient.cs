    ...
    partial class BehaviorDb
    {
        private _ EntAncient = () => Behav()
            .Init("Ent Ancient",
                new State(
                    ...
                    new State("HugeMob",
                        ...
                        new TossObject("Ent", 5, 350, 100000),
                        new TossObject("Ent", 5, 170, 100000),
                        new TossObject("Ent", 5, 290, 100000),
                        new TossObject("Ent", 7, 340, 100000),
                        new TossObject("Ent", 7, 160, 100000),
                        new TossObject("Ent", 7, 280, 100000),
                        new TossObject("Ent", 10, 330, 100000),
                        new TossObject("Ent", 10, 150, 100000),
                        new TossObject("Ent", 10, 270, 100000),
                    ...
                    new State("Mob",
                        ...
                        new TossObject("Ent", 5, 350, 100000),
                        new TossObject("Ent", 6, 10, 100000),
                        new TossObject("Ent", 7, 340, 100000),
                        new TimedTransition(5000, "Wait")
                        ),
            ...
            .Init("Actual Ent Ancient",
                ...
                new ItemLoot("Ent Ancients Log", 0.013),
                new ItemLoot("Corpse of an Ent Ancient", 0.013),
                new ItemLoot("Ripe Apple", 0.013),
                new ItemLoot("Clump of Bark", 0.013),
