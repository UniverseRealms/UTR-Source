...
public class MarketMyOffersScreen extends Sprite
   {
      ...
      private function onOffersGet(param1:Vector.<PlayerShopItem>) : void
      {
         ...
         _loc2_.graphics.drawRect(0,0,700,480);
         ...
         this.scrollBar = new Scrollbar(16,480);
         this.scrollBar.y += 10 ;
         this.scrollBar.x = 643;
      ...
      {
          this.offerHolder.y = (6 - (this.scrollBar.pos() * ((this.offerHolder.height + 12) - HEIGHT)))
      }
   }
}
