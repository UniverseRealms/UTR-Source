...
namespace wServer.networking.server
{
    ...
    public class Server
    {
        ...
        public const int BufferSize = 0x60000;
        ...
        internal void Start()
        {
            ...
            Program.Log.Info($"Listening on port {_port}...");
        ...
        public void Disconnect(Client client)
        {
            ...
            catch (Exception e)
            {
                ...
                if (se == null || se.SocketErrorCode != SocketError.NotConnected)
                    Program.Debug(typeof(Server), e.ToString(), true);
            }
            client.Skt.Close();
        ...
        public void Stop()
        {
            Program.Log.Info("Stopping server...");
