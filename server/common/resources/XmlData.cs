...
namespace common.resources
{
    ...
    {
        public static readonly ILog log = LogManager.GetLogger(typeof(XmlData));
        ...
        private readonly Dictionary<string, ushort> d_name2type_obj;
        ...
        private readonly Dictionary<ushort, XElement> type2elem_equipSet;
        private readonly Dictionary<ushort, string> type2id_equipSet;
        private readonly Dictionary<string, ushort> id2type_equipSet;
        private readonly Dictionary<ushort, XElement> type2elem_lootBox;
        private readonly Dictionary<ushort, string> type2id_lootBox;
        private readonly Dictionary<string, ushort> id2type_lootBox;
        private readonly Dictionary<ushort, ushort> skinType2equipSetType;
        ...
        private readonly Dictionary<ushort, EquipmentSetDesc> equipmentSets;
        private readonly Dictionary<ushort, Lootbox> lootBox;
        private readonly Dictionary<ushort, PlayerDesc> classes;
        private readonly Dictionary<ushort, ObjectDesc> merchants;
        private readonly Dictionary<ushort, PetDesc> pets;
        private readonly Dictionary<ushort, PetSkinDesc> petSkins;
        private readonly Dictionary<ushort, PetBehaviorDesc> petBehaviors;
        private readonly Dictionary<ushort, PetAbilityDesc> petAbilities;
        private readonly Dictionary<int, ItemType> slotType2ItemType;
        ...
        private void AddObjects(XElement root)
        {
            foreach (var elem in root.XPathSelectElements("//Object"))
            {
                ...
                var displayId = elem.Element("DisplayId")?.Value;
        ...
        private void AddEquipmentSets(XElement root)
        {
            foreach (var elem in root.XPathSelectElements("//EquipmentSet"))
            {
                ...
                equipmentSets[type] = EquipmentSetDesc.FromElem(type, elem, out ushort skinType);
