...
namespace wServer.realm.entities
{
    partial class Player
    {
        public Tuple<Item> GetUnboxResult(int crateType, Random rand)
        {
            ...
            Item item = Manager.Resources.GameData.Items[Manager.Resources.GameData.IdToObjectType["10000 Gold"]];
        ...
        public string LootboxType(int crateName)
        {
            switch (crateName)
            {
                ...
                case 6: return "Legendary Lootbox";
                case 7: return "Event Lootbox";
            }
            return "Unknown";
        }
