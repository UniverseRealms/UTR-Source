        ...
        private _ Golems = () => Behav()
                ...
                new State(
                    ...
                    new State("player_nearby",
                        ...
                        new State("first_satellites",
                            new Spawn("Green Satellite", 1, coolDown: 400),
                            new Spawn("Gray Satellite 3", 1, coolDown: 400),
            ...
            .Init("Paper Golem",
                new State(
                    ...
                    new State("player_nearby",
                        new Spawn("Blue Satellite", 1, coolDown: 400),
                        new Spawn("Gray Satellite 1", 1, coolDown: 400),
            ...
            .Init("Fire Golem",
                new State(
                    ...
                    new State("player_nearby",
                        ...
                        new Spawn("Red Satellite", 1, coolDown: 400),
                        new Spawn("Gray Satellite 1", 1, coolDown: 400),
                        new State("slowshot",
                            new Shoot(10, projectileIndex: 0, predictive: 0.5, coolDown: 400, coolDownOffset: 600),
                            new TimedTransition(5000, "megashot")
                            ),
                        new State("megashot",
                            new Flash(0xffffffff, 0.2, 5),
                            new Shoot(10, projectileIndex: 1, predictive: 0.2, coolDown: 400, coolDownOffset: 1000),
            ...
            .Init("Darkness Golem",
                new State(
                    ...
                    new State("player_nearby",
                        new State("first_satellites",
                            new Spawn("Green Satellite", 1, coolDown: 400),
                            new Spawn("Gray Satellite 2", 1, coolDown: 400),
                        ...
                        new State("follow",
                            new Shoot(6, projectileIndex: 0, coolDown: 400),
                            new Prioritize(
                                new StayAbove(1.2, 65),
