...
public class ParseServerDataCommand {
    ...
    private function makeServer(_arg1:XML):Server {
        return (new Server().setName(_arg1.Name).setAddress(_arg1.DNS).setPort(_arg1.Port).setLatLong(Number(_arg1.Lat), Number(_arg1.Long)).setUsage(_arg1.Usage).setIsAdminOnly(_arg1.hasOwnProperty("AdminOnly")));
    }
