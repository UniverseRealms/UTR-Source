...
public class ChatListItemFactory {
    ...
    private static const PARTY:String = Parameters.PARTY_CHAT_NAME;
    private static const STAFF:String = Parameters.STAFF_CHAT_NAME;
    ...
    private function getNameColor():uint {
        ...
        if (this.message.recipient == PARTY) {
            return (0xDE01FC);
        }
        if (this.message.recipient == STAFF) {
            return (0xADD8E6);
        }
