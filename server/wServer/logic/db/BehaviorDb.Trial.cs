...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("CR Illusion Manifestation",
                new State(
                  new Shoot(10, count: 8, projectileIndex: 0, coolDown: 1000, coolDownOffset: 250),
                  new State("fight",
                      new Follow(0.4, 8, 1),
                      new Shoot(10, count: 8, shootAngle: 18, projectileIndex: 1, coolDown: 2000, coolDownOffset: 1000),
                      new Shoot(10, count: 4, shootAngle: 18, projectileIndex: 2, coolDown: 3700, coolDownOffset: 1500),
                  ...
                  new Shoot(10, count: 5, projectileIndex: 2, coolDown: 1000, coolDownOffset: 500),
        ...
        .Init("CR Pillar of Illusions",
              ...
              .Init("The Illusionist",
                new State(
                    ...
                    new HpLessTransition(0.4, "sinkstate"),
                    new RealmPortalDrop(),
                    new State("default",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                    ...
                    new State("start",
                        ...
                        new TossObject("CR Illusion Manifestation", range: 4, coolDown: 8000),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Wander(0.4),
                        new Shoot(10, count: 7, projectileIndex: 1, predictive: 1, coolDownOffset: 600, coolDown: 1800),
                        new Shoot(10, count: 1, projectileIndex: 1, coolDown: 400),
                    ...
                    new State("command",
                        new Shoot(10, count: 1, projectileIndex: 0, coolDown: 400),
                        new Shoot(10, count: 1, projectileIndex: 0, coolDown: 400, coolDownOffset: 1),
                ...
                new Threshold(0.01,
                    new ItemLoot("Illusionist Spell", 0.02),
                    new ItemLoot("Manifestation Cloak", 0.0067),
                    new ItemLoot("Mimicry Dagger", 0.002),
                    ...
                    new ItemLoot("Crypt of the Illusionist Key", 0.005),
                    new ItemLoot("Rusted Dagger", 0.00143),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Wishing Pet Stone", 0.001)
                )
            )
    ;
    }
