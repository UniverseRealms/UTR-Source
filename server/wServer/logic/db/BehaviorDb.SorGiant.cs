        ...
        private _ SorGiant = () => Behav()
            .Init("Sorgigas, the Sor Giant",
                new State(
                    ...
                    new Prioritize(
                        ...
                        new Shoot(8, count: 4, shootAngle: 16, projectileIndex: 1, coolDown: 400),
                        new Grenade(4, 120, range: 8, coolDown: 400, effect: ConditionEffectIndex.Nullified, effectDuration: 4, color: 0x00FF00),
                   ...
                   new State("Return",
                    ...
                    new State("SpawnStuff",
                        ...
                        new State("Quadforce1",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 60, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "Quadforce2")
                        ),
                        new State("Quadforce2",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 60, fixedAngle: 15, coolDown: 400),
                            new TimedTransition(200, "Quadforce3")
                        ),
                        new State("Quadforce3",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 60, fixedAngle: 30, coolDown: 400),
                            new TimedTransition(200, "Quadforce4")
                        ),
                        new State("Quadforce4",
                            new Shoot(0, projectileIndex: 1, count: 5, shootAngle: 60, fixedAngle: 45, coolDown: 400),
                    ...
                    new State("Fight3",
                        ...
                        new Grenade(6, 120, range: 8, coolDown: 2000, fixedAngle: 90, effect: ConditionEffectIndex.Nullified, effectDuration: 4, color: 0x00FF00),
                        new Grenade(6, 120, range: 8, coolDown: 2000, fixedAngle: 180, effect: ConditionEffectIndex.Nullified, effectDuration: 4, color: 0x00FF00),
                        new Grenade(6, 120, range: 8, coolDown: 2000, fixedAngle: 270, effect: ConditionEffectIndex.Nullified, effectDuration: 4, color: 0x00FF00),
                        new Grenade(6, 120, range: 8, coolDown: 2000, fixedAngle: 0, effect: ConditionEffectIndex.Nullified, effectDuration: 4, color: 0x00FF00),
            ...
            .Init("Sor Soul",
                new State(
                    ...
                    new Shoot(10, count: 6, projectileIndex: 0, coolDown: 400)
                    )
            )
            ;
    }
