             ...
             new State(
                 new ScaleHP(0.3),
                     ...
                     new State("state1",
                      ...
                      new Grenade(3, 100, range: 8, fixedAngle: 90, coolDown: 3000),
                       new Grenade(3, 100, range: 8, fixedAngle: 0, coolDown: 3000),
                        new Grenade(3, 100, range: 8, fixedAngle: 180, coolDown: 3000),
                        new Grenade(3, 100, range: 8, fixedAngle: 270, coolDown: 3000),
                     ...
                     new State("state2",
                          ...
                          new Shoot(6.3, count: 1, projectileIndex: 3, coolDown: 1700, coolDownOffset: 850, shootAngle: 90),
                          new Shoot(6.3, count: 10, projectileIndex: 0, coolDown: 5000),
                          new Shoot(6.3, count: 10, projectileIndex: 0, coolDown: 5000, coolDownOffset: 850, shootAngle: 90),
                          new Shoot(6.3, count: 10, projectileIndex: 1, coolDown: 6000),
                          new Shoot(6.3, count: 10, projectileIndex: 1, coolDown: 6000, coolDownOffset: 850, shootAngle: 90),
                          new TimedTransition(8000, "GRENADES"),
                         new ChangeSize(15, 140)
                         ),
                    new State("GRENADES",
                        new Grenade(5, 140, fixedAngle: 0, coolDown: 2000),
                        new Grenade(5, 140, fixedAngle: 90, coolDown: 2000, coolDownOffset: 500),
                        new Grenade(5, 140, fixedAngle: 180, coolDown: 2000, coolDownOffset: 1000),
                        new Grenade(5, 140, fixedAngle: 0, coolDown: 2000, coolDownOffset: 1500),
                        new TimedTransition(4200, "state2")
                        )
                 ),
                 new Threshold(0.18,
                    new ItemLoot("Thunderstorm Bow", 0.01),
                    new ItemLoot("Challenger Seal", 0.01),
                    new ItemLoot("Nimbus Ring", 0.002),
          ...
          .Init("Hideout Electric Overseer",
           ...
           .Init("Hideout Wraith",
                     ...
                     new State("WraithWalk",
                        ...
                        new Shoot(8.4, count: 1, projectileIndex: 0, coolDown: 400),
                 ...
                 new Threshold(0.6,
                      new ItemLoot("Prism of Figments", 0.06),
                      new ItemLoot("Wyvern Skin Armor", 0.06)
                     )
             )
          ...
          .Init("Hideout Cloud Shield 2",
            ...
            .Init("Hideout Thunder Menace",
                     ...
                     new State("WraithWalk",
                        new Follow(0.5, 8, 1),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(8.4, count: 2, shootAngle: 6, projectileIndex: 0, coolDown: 400),
        ...
        .Init("Iegon the Weather God",
                new State(
                    ...
                    new State("fight2",
                         ...
                         new Shoot(8.4, count: 3, fixedAngle: 0, shootAngle: 8, projectileIndex: 2, coolDown: 400),
                         new Shoot(8.4, count: 3, fixedAngle: 90, shootAngle: 8, projectileIndex: 2, coolDown: 400),
                         new Shoot(8.4, count: 3, fixedAngle: 180, shootAngle: 8, projectileIndex: 2, coolDown: 400),
                         new Shoot(8.4, count: 3, fixedAngle: 270, shootAngle: 8, projectileIndex: 2, coolDown: 400),
                ...
                new Threshold(0.01,
                    new ItemLoot("Thunderstorm Bow", 0.01),
                    new ItemLoot("Challenger Seal", 0.01),
                    new ItemLoot("Nimbus Ring", 0.005),
                    new ItemLoot("Potion of Dexterity", 1),
                    ...
                    new ItemLoot("Storm Palace Key", 0.005),
                    new ItemLoot("Rusted Bow", 0.00112),
                    new ItemLoot("Eternal Essence", 0.0005),
                    new ItemLoot("Potion of Luck", 0.2),
                    new ItemLoot("Thunder Pet Stone", 0.001)
                )
            )
        ;
    }
