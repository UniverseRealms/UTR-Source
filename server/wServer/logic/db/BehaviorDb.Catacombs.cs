...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Corrupted Flames of Fate",
                new State(
                    ...
                    new State("trailofdeath",
                        ...
                        new Shoot(10, count: 1, shootAngle: 8, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                ...
                new Threshold(0.01,
                    new ItemLoot("Blazing Robe", 0.02),
                    new ItemLoot("Staff of Evocation", 0.0067),
                    ...
                    new ItemLoot("Bloody Pet Stone", 0.001)
                )
            )
        ...
        .Init("Catacombs Turret 2",
                                new State(
                                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                                        new Shoot(6, count: 1, coolDown: 400)
                                                )
              )
        ...
        .Init("Wizard of Evil Souls",
             new State(
                   ...
                   new State("Rush",
                     ...
                     new Shoot(10, count: 1, projectileIndex: 2, coolDown: 400),
        ...
        .Init("Treasure Statue of the Catacombs",
                ...
                new Threshold(0.01,
                    new ItemLoot("Dragon-Scale Jacket", 0.00167),
                    new ItemLoot("Tridorno's Platemail", 0.00083),
                    new ItemLoot("Tri-Scale Ring", 0.00033),
                    new ItemLoot("Deathbringer Kunai", 0.00167),
                    new ItemLoot("Doomages talon", 0.00083),
                    new ItemLoot("The Grave’s Calling", 0.00033),
                    new ItemLoot("Blazing Robe", 0.00167),
                    new ItemLoot("Staff of Evocation", 0.00083),
                    new ItemLoot("Everlasting Inferno", 0.00033),
                    new ItemLoot("Potion of Life", 0.5),
                    new ItemLoot("Potion of Restoration", 0.03),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.05),
                    new ItemLoot("Rusted Ring", 0.000167),
                    new ItemLoot("Eternal Essence", 0.000167)
                                                )
                        )
        .Init("Ugajuajn",
             new State(
        ...
        .Init("Doomages",
                ...
                new Threshold(0.01,
                    new ItemLoot("Deathbringer Kunai", 0.02),
                    new ItemLoot("Doomage's Talon", 0.0067),
                    new ItemLoot("The Grave's Calling", 0.0016),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.05),
                    new ItemLoot("Rusted Platemail", 0.00119),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Ogre Pet Stone", 0.001)
                )
            )
        ...
        .Init("Tridorno",
                new State(
                    ...
                    new State("WanderandShoot",
                     ...
                     new State("LightningFam",
                        ...
                        new HpLessTransition(0.75, "ReturnToSpawn")
                        ),
                     ...
                     new State("spodermen",
                        ...
                        new TossObject("Arena Spider", 10, 100, coolDown: 9999999),
                        new TossObject("Arena Spider", 13, 200, coolDown: 9999999),
                        new TossObject("Arena Spider", 12, 290, coolDown: 9999999),
                        new TossObject("Arena Spider", 12, 330, coolDown: 9999999),
                ...
                new Threshold(0.01,
                    new ItemLoot("Dragon-Scale Jacket", 0.02),
                    new ItemLoot("Tridorno's Platemail", 0.0067),
                    new ItemLoot("Tri-Scale Ring", 0.002),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.05),
                    new ItemLoot("The Catacombs Key", 0.005),
                    new ItemLoot("Rusted Ring", 0.00125),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Duo Pet Stone", 0.001)
                )
            )
        ;
    }
