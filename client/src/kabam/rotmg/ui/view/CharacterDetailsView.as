...
public class CharacterDetailsView extends Sprite {
    ...
    public function CharacterDetailsView() {
        ...
        this.gotoAchievementList= new Signal();
        ...
        this.achieveClicked = new NativeSignal(this.achieveButton, MouseEvent.CLICK);
        super();
    }
    ...
    private function createButton(_arg1:String):void {
        ...
        this.achieveButton = this.iconButtonFactory.create(this.imageFactory.getImageFromSet(IMAGE_SET_NAME, OPTIONS_IMAGE_ID), "", TextKey.CHARACTER_DETAILS_VIEW_ACHIEVEMENTS, "achieve");
        this.achieveClicked = new NativeSignal(this.achieveButton, MouseEvent.CLICK, MouseEvent);
        this.achieveClicked.add(this.onAchieveClick);

        this.button.x = 172;
        this.button.y = 4;
        addChild(this.button);
        this.achieveButton.x = 150;
        this.achieveButton.y = 4;
        //addChild(this.achieveButton);
    }
    ...
    private function onAchieveClick(_arg1:MouseEvent):void {
        this.gotoAchievementList.dispatch();
    }
