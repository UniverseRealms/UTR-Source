    ...
    partial class BehaviorDb
    {
        private _ Crimson = () => Behav()
            .Init("Hades",
                new State(
                   ...
                   new State("talktransition3",
                    ...
                    new State("FranticFlamePhase",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(10, count: 8, shootAngle: 16, projectileIndex: 2, coolDown: 400),
                    ...
                    new State("FranticFlamePhase2",
                        new Shoot(10, count: 9, shootAngle: 16, projectileIndex: 2, coolDown: 400),
                    ...
                    new State("FranticFlamePhase3",
                        ...
                        new Shoot(10, count: 4, shootAngle: 4, projectileIndex: 2, coolDown: 400),
                        new Shoot(10, count: 4, shootAngle: 4, projectileIndex: 2, coolDown: 400, coolDownOffset: 1),
                    ...
                    new State("LockingTargetPhase",
                        ...
                        new TossObject("HadesTarget", angle: null, range: 10, coolDown: 400),
                    ...
                    new State("RushingShotgunPhase",
                        new Follow(0.4, 8, 1),
                        new Shoot(10, count: 3, shootAngle: 16, projectileIndex: 2, coolDown: 400),
                ...
                new Threshold(0.01,
                    new ItemLoot("Burning Blaze", 0.02),
                    new ItemLoot("Hell's Retriever", 0.0067),
                    new ItemLoot("Crimson Lantern", 0.002),
                    ...
                    new ItemLoot("Crimson Showdown Key", 0.005),
                    new ItemLoot("Malgoric Token", 0.005),
                    new ItemLoot("Satanic Pet Stone", 0.001),
        ...
        .Init("Crimson Trap",
            ...
            new State(
                ...
                new State("wizzy1",
                    ...
                    new Shoot(10, count: 2, shootAngle: 2, projectileIndex: 1, coolDown: 400),
         ...
         .Init("CRIM Crimson Warrior",
            new State(
                ...
                new State("fight3",
                    new Wander(0.1),
                    new Shoot(10, count: 3, shootAngle: 6, projectileIndex: 2, coolDown: 400),
