...
import com.company.assembleegameclient.objects.EventGod;
...
public class MiniMapImp extends MiniMap {
    ...
    override public function setMap(_arg1:Map):void {
        this.map = _arg1;
        this.makeViewModel();
    }
    ...
    override public function draw():void {
        ...
        for each (_local10 in map.goDict_) {
            if (!((_local10.props_.noMiniMap_) || ((_local10 == this.focus)))) {
                ...
                if (_local16 != null) {
                    if (_local16.isPaused()) {
                        ...
                        if (_local16.isFellowGuild_) {
                            ...
                            mapDotColor = 0xFFFF00;
                        }
                    }
                }
                else {
                    if ((_local10 is Character)) {
                        /*if(_local10.props_.id_ == "Frost Knight")
                        {
                            mapDotColor = 0xffffff;
                        }else*/
                        if (_local10.props_.isEnemy_) {
                            mapDotColor = 0xFF0000;
                        }
                        else if (_local10.props_.isAlly_) {
                            mapDotColor = 0xFFFFA0;
                        }
                        else {
                            mapDotColor = gameObjectToColor(_local10);
                        }
                    }
                    else {
                ...
                mapDotX = (((this.mapMatrix_.a * _local10.x_) + (this.mapMatrix_.c * _local10.y_)) + this.mapMatrix_.tx);
                mapDotY = (((this.mapMatrix_.b * _local10.x_) + (this.mapMatrix_.d * _local10.y_)) + this.mapMatrix_.ty);
                        if ((((((((mapDotX <= (-(this._width) / 2))) || ((mapDotX >= (this._width / 2))))) || ((mapDotY <= (-(this._height) / 2))))) || ((mapDotY >= (this._height / 2))))) {
                            RectangleUtil.lineSegmentIntersectXY(this.windowRect_, 0, 0, mapDotX, mapDotY, this.tempPoint);
                            mapDotX = this.tempPoint.x;
                            mapDotY = this.tempPoint.y;
                        }
                if (((((!((_local16 == null))) && (this.isMouseOver))) && ((((this.menu == null)) || ((this.menu.parent == null)))))) {
                    _local19 = (_local8 - mapDotX);
                    _local20 = (_local9 - mapDotY);
                    _local21 = ((_local19 * _local19) + (_local20 * _local20));
                    if (_local21 < MOUSE_DIST_SQ) {
                        this.players_.push(_local16);
                    }
                }
                _local7.beginFill(mapDotColor);
                _local7.drawRect((mapDotX - 2), (mapDotY - 2), 4, 4);
                _local7.endFill();
            }
        }
