...
public class OrbComparison extends SlotComparison {
    ...
    override protected function compareSlots(_arg1:XML, _arg2:XML):void {
        ...
        if (((!((_local3 == null))) && (!((_local4 == null))))) {
            ...
            _local8 = int(_local3.@range);
            comparisonStringBuilder.pushParams(TextKey.STASIS_GROUP, {"stasis": new LineBuilder().setParams("{seconds} seconds within {range} sqrs", {"seconds": _local5, "range": _local8}).setPrefix(TooltipHelper.getOpenTag(_local7)).setPostfix(TooltipHelper.getCloseTag())});
