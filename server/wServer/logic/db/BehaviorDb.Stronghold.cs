         ...
         .Init("Golem King A",
                new State(
                    ...
                    new State("FoollowShootPhase2",
                        ...
                        new Shoot(10, count: 13, projectileIndex: 5, coolDown: 400),
                    ...
                    new State("GoBlam",
                        new Shoot(10, count: 3, shootAngle: 1, fixedAngle: 90, projectileIndex: 0, coolDown: 400),
                        new Shoot(10, count: 3, shootAngle: 1, fixedAngle: 180, projectileIndex: 0, coolDown: 400),
                        new Shoot(10, count: 3, shootAngle: 1, fixedAngle: 270, projectileIndex: 0, coolDown: 400),
                        new Shoot(10, count: 3, shootAngle: 1, fixedAngle: 0, projectileIndex: 0, coolDown: 400),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
        ...
        .Init("Golem King B",
                new State(
                    ...
                    new State("SwirlAndBlamo",
                        ...
                        new Shoot(10, count: 7, projectileIndex: 2, coolDown: 3088),
                        new Shoot(10, count: 3, shootAngle: 10, projectileIndex: 5, coolDown: 400),
                        new TimedTransition(6750, "AnnoyingStage")
                        ),
                    new State("AnnoyingStage",
                        new Follow(0.1, 8, 1),
                        new Shoot(10, count: 14, projectileIndex: 9, coolDown: 4750),
                        new Shoot(10, count: 10, projectileIndex: 4, coolDown: 400),
                ...
                new State(
                    ...
                    new State("HueHueShotgun",
                        new Follow(1.0, 8, 1),
                        new Shoot(10, count: 1, shootAngle: 16, projectileIndex: 0, coolDown: 400),
