    ...
    partial class BehaviorDb
    {
        private _ Yazanahar = () => Behav()
            .Init("Yazanahar",
                    ...
                    new State(
                        ...
                        new State(
                            ...
                            new State("WeirdMovement2",
                                ...
                                new Shoot(10, count: 8, shootAngle: 8, projectileIndex: 4, coolDown: 400),
                        ...
                        new State("swagche",
                            ...
                            new Shoot(10, 4, projectileIndex: 4, predictive: 1, shootAngle: 12, coolDown: 400),
                            new Shoot(10, 1, projectileIndex: 6, coolDown: 400),
                            new Shoot(10, 1, projectileIndex: 6, coolDown: 400, coolDownOffset: 100),
                ...
                new Threshold(0.01,
                    new ItemLoot("Morphologic Protection", 0.0084),
                    new ItemLoot("Soul of Yazanahar", 0.0046),
            ...
            .Init("Split Yazanahar",
                new State(
                    ...
                    new State("time",
                        ...
                        new Shoot(10, count: 8, shootAngle: 6, projectileIndex: 1, coolDown: 400),
            ...
            .Init("Yazanahar Helper",
                new State(
                    new EntityNotExistsTransition("Yazanahar", 99, "deth"),
                    new ConditionalEffect(ConditionEffectIndex.StasisImmune),
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new State("swag",
        ...
        .Init("Krokanich",
                new State(
                    ...
                    new State(
                        new Reproduce("Vicious Croc", 20, 10, coolDown: 2000),
                    new State("fight2",
                    ...
                    new State("fight5",
                        ...
                        new Shoot(10, count: 4, shootAngle: 12, projectileIndex: 4, coolDown: 400),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                ...
                new Threshold(0.01,
                    new ItemLoot("Reptilian Hide", 0.02),
                    new ItemLoot("Fang of the Croc", 0.0067),
                    ...
                    new ItemLoot("Rusted Katana", 0.00143),
         ...
         .Init("Xanarich, the Chosen One",
                new State(
                   ...
                   new State("begin",
                    ...
                    new State(
                        new Reproduce("Book of Lore", 20, 8, coolDown: 1000),
                    new State("fight2",
                        new Shoot(1, count: 4, projectileIndex: 1, coolDown: 400, fixedAngle: 90, rotateAngle: 10, coolDownOffset: 0, shootAngle: 90),
                        new Shoot(1, count: 8, projectileIndex: 1, coolDown: 10000, fixedAngle: 180, coolDownOffset: 2000, shootAngle: 45),
                        new Shoot(1, count: 4, projectileIndex: 1, coolDown: 400, fixedAngle: 180, rotateAngle: -10, coolDownOffset: 0, shootAngle: 90),
                    ...
                    new State("fight4",
                        ...
                        new Shoot(10, count: 5, shootAngle: 10, projectileIndex: 0, coolDown: 400),
                        new Shoot(10, count: 6, projectileIndex: 3, shootAngle: 8, coolDown: 500, fixedAngle: 0),
                    ...
                    new State("fight5",
                        new Wander(0.1),
                        new Shoot(10, count: 6, projectileIndex: 4, coolDown: 400),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                    ...
                    new State("spiral",
                        ...
                        new State("Duoforce1",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 0, coolDown: 400),
                            new Shoot(10, count: 5, shootAngle: 10, projectileIndex: 1, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "Duoforce2")
                        ),
                        new State("Duoforce2",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 15, coolDown: 400),
                            new TimedTransition(200, "Duoforce3")
                        ),
                        new State("Duoforce3",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 30, coolDown: 400),
                            new TimedTransition(200, "Duoforce4")
                        ),
                        new State("Duoforce4",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 45, coolDown: 400),
                            new TimedTransition(200, "Duoforce21")
                        ),
                         new State("Duoforce21",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 60, coolDown: 400),
                            new Shoot(10, count: 5, shootAngle: 10, projectileIndex: 1, fixedAngle: 90, coolDown: 400),
                            new TimedTransition(200, "Duoforce23")
                        ),
                         new State("Duoforce23",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 75, coolDown: 400),
                            new TimedTransition(200, "Duoforce25")
                        ),
                         new State("Duoforce25",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 90, coolDown: 400),
                            new TimedTransition(200, "Duoforce26")
                        ),
                         new State("Duoforce26",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 90, coolDown: 400),
                            new TimedTransition(200, "Duoforce24")
                        ),
                         new State("Duoforce24",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 75, coolDown: 400),
                            new Shoot(10, count: 5, shootAngle: 10, projectileIndex: 1, fixedAngle: 180, coolDown: 400),
                            new TimedTransition(200, "Duoforce22")
                        ),
                          new State("Duoforce22",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 60, coolDown: 400),
                            new TimedTransition(200, "Duoforce5")
                        ),
                        new State("Duoforce5",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 45, coolDown: 400),
                            new TimedTransition(200, "Duoforce6")
                        ),
                        new State("Duoforce6",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 30, coolDown: 400),
                            new TimedTransition(200, "Duoforce7")
                        ),
                        new State("Duoforce7",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 15, coolDown: 400),
                            new Shoot(10, count: 5, shootAngle: 10, projectileIndex: 1, fixedAngle: 270, coolDown: 400),
                            new TimedTransition(200, "Duoforce8")
                        ),
                        new State("Duoforce8",
                            new Shoot(0, projectileIndex: 2, count: 2, shootAngle: 180, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "Duoforce1")
                            )
                        )
                    ),
                    new State("rage",
                ...
                new Threshold(0.01,
                    new ItemLoot("Belt of the Ancients", 0.002),
                    ...
                    new TierLoot(4, ItemType.Armor, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.05),
                    new ItemLoot("Ancient Depths Key", 0.005),
                    new ItemLoot("Rusted Ring", 0.00125),
                    new ItemLoot("Eternal Essence", 0.001),
                    new ItemLoot("Ancient Pet Stone", 0.001)
                )
            )
