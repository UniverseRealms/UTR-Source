...
namespace wServer.networking.packets.incoming
{
    public class Hello : IncomingMessage
    {
        ...
        public bool IgnoreAllyProjectiles { get; set; }
        public bool IgnoreAllyDamageText { get; set; }
        ...
        protected override void Read(NReader rdr)
        {
            ...
            Sig = rdr.ReadUTF();
            Time = rdr.ReadDouble();
            IgnoreAllyProjectiles = rdr.ReadBoolean();
            IgnoreAllyDamageText = rdr.ReadBoolean();
        }
        ...
        protected override void Write(NWriter wtr)
        {
            ...
            wtr.WriteUTF(Sig);
            wtr.Write(Time);
            wtr.Write(IgnoreAllyProjectiles);
            wtr.Write(IgnoreAllyDamageText);
        }
    }
}