        ...
        .Init("NM Green Dragon God",
                new State(
                    ...
                    new State("chaseandrek",
                        ...
                        new Shoot(10, count: 7, shootAngle: 38, projectileIndex: 4, predictive: 0.5, coolDown: 400),
                        new Shoot(10, count: 5, shootAngle: 38, projectileIndex: 1, predictive: 0.5, coolDown: 400),
                        new TimedTransition(9000, "returntospawn")
                        ),
                    new State("returntospawn",
                        new ReturnToSpawn(speed: 0.5),
        ...
        .Init("NM Red Dragon God",
                new State(
                    ...
                    new State("breath",
                        ...
                        new Shoot(10, count: 3, shootAngle: 3, projectileIndex: 0, coolDown: 400),
            ...
            .Init("lod Ivory Wyvern",
                new State(
                   ...
                   new State("talk3",
                    ...
                    new State("Mirrors",
                        ...
                        new Shoot(8.4, count: 7, shootAngle: 16, projectileIndex: 0, coolDown: 400),
                        new HpLessTransition(0.8, "movetothemiddle2")
                        ),
                ...
                new Threshold(0.15,
                    new ItemLoot("Rusted Ring", 0.0005),
                    new ItemLoot("Twilight Star", 0.002),
                    new TierLoot(12, ItemType.Weapon, 0.065),
                    new TierLoot(12, ItemType.Weapon, 0.055),
                    new TierLoot(6, ItemType.Ability, 0.065),
                    new TierLoot(5, ItemType.Ability, 0.0685),
                    new TierLoot(13, ItemType.Armor, 0.0525),
                    new ItemLoot("Midnight Star", 0.06),
                    new ItemLoot("Ivory Ring", 0.055),
                    new ItemLoot("Large Ivory Dragon Scale Cloth", 0.045),
                    new ItemLoot("Small Ivory Dragon Scale Cloth", 0.047)
            )
