...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Riv the Heavenly Champion",
                    ...
                    new State("ReturnToSpawn1",
                      ...
                      new State("AgileShotguns",
                        ...
                        new State("Quadforce1",
                            ...
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 70, fixedAngle: 0, coolDown: 400),
                            new TimedTransition(200, "Quadforce2")
                        ),
                        new State("Quadforce2",
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 70, fixedAngle: 15, coolDown: 400),
                        ...
                        new State("Quadforce3",
                            ...
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 70, fixedAngle: 30, coolDown: 400),
                            new TimedTransition(200, "Quadforce4")
                        ),
                        new State("Quadforce4",
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 70, fixedAngle: 45, coolDown: 400),
                        ...
                        new State("Quadforce41",
                            ...
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 70, fixedAngle: 60, coolDown: 400),
                ...
                new MostDamagers(3,
                         new ItemLoot("Potion of Protection", 0.0001)
                     ),
                new Threshold(0.01,
