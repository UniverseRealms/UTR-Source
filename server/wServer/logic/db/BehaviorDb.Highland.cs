    ...
    partial class BehaviorDb
    {
          ...
          .Init("Flamer",
            ...
            .Init("Left Horizontal Trap",
                new State(
                    ...
                    new State("weak_effect",
                        new Shoot(1, fixedAngle: 0, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(2000, "blind_effect")
                        ),
                    new State("blind_effect",
                        new Shoot(1, fixedAngle: 0, projectileIndex: 1, coolDown: 400),
                        new TimedTransition(2000, "pierce_effect")
                        ),
                    new State("pierce_effect",
                        new Shoot(1, fixedAngle: 0, projectileIndex: 2, coolDown: 400),
            ...
            .Init("Top Vertical Trap",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new State("weak_effect",
                        new Shoot(1, fixedAngle: 90, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(2000, "blind_effect")
                        ),
                    new State("blind_effect",
                        new Shoot(1, fixedAngle: 90, projectileIndex: 1, coolDown: 400),
                        new TimedTransition(2000, "pierce_effect")
                        ),
                    new State("pierce_effect",
                        new Shoot(1, fixedAngle: 90, projectileIndex: 2, coolDown: 400),
                        new TimedTransition(2000, "weak_effect")
                        ),
                    new Decay(6000)
                    )
            ...
            .Init("45-225 Diagonal Trap",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new State("weak_effect",
                        new Shoot(1, fixedAngle: 45, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(2000, "blind_effect")
                        ),
                    new State("blind_effect",
                        new Shoot(1, fixedAngle: 45, projectileIndex: 1, coolDown: 400),
                        new TimedTransition(2000, "pierce_effect")
                        ),
                    new State("pierce_effect",
                        new Shoot(1, fixedAngle: 45, projectileIndex: 2, coolDown: 400),
                        new TimedTransition(2000, "weak_effect")
                        ),
                    new Decay(6000)
                    )
            ...
            .Init("135-315 Diagonal Trap",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new State("weak_effect",
                        new Shoot(1, fixedAngle: 135, projectileIndex: 0, coolDown: 400),
                        new TimedTransition(2000, "blind_effect")
                        ),
                    new State("blind_effect",
                        new Shoot(1, fixedAngle: 135, projectileIndex: 1, coolDown: 400),
                        new TimedTransition(2000, "pierce_effect")
                        ),
                    new State("pierce_effect",
                        new Shoot(1, fixedAngle: 135, projectileIndex: 2, coolDown: 400),
                        new TimedTransition(2000, "weak_effect")
                        ),
                    new Decay(6000)
                    )
            ...
            .Init("Urgle",
                new State(
                    ...
                    new State("toss_horizontal_traps",
                        new TossObject("Left Horizontal Trap", range: 9, angle: 130, coolDown: 100000),
                        new TossObject("Left Horizontal Trap", range: 10, angle: 180, coolDown: 100000),
                        new TossObject("Left Horizontal Trap", range: 9, angle: 220, coolDown: 100000),
                        new TimedTransition(1000, "toss_vertical_traps")
                        ),
                    new State("toss_vertical_traps",
                        new TossObject("Top Vertical Trap", range: 8, angle: 160, coolDown: 100000),
                        new TossObject("Top Vertical Trap", range: 10, angle: 120, coolDown: 100000),
                        new TossObject("Top Vertical Trap", range: 10, angle: 80, coolDown: 100000),
                        new TossObject("Top Vertical Trap", range: 8, angle: 40, coolDown: 100000),
                        new TimedTransition(1000, "toss_diagonal_traps")
                        ),
                    new State("toss_diagonal_traps",
                        new TossObject("45-225 Diagonal Trap", range: 2, angle: 315, coolDown: 100000),
                        new TossObject("45-225 Diagonal Trap", range: 7, angle: 315, coolDown: 100000),
                        new TossObject("45-225 Diagonal Trap", range: 11, angle: 135, coolDown: 100000),
                        new TossObject("45-225 Diagonal Trap", range: 6, angle: 135, coolDown: 100000),
                        new TossObject("135-315 Diagonal Trap", range: 2, angle: 225, coolDown: 100000),
                        new TossObject("135-315 Diagonal Trap", range: 7, angle: 225, coolDown: 100000),
                        new TossObject("135-315 Diagonal Trap", range: 11, angle: 45, coolDown: 100000),
                        new TossObject("135-315 Diagonal Trap", range: 6, angle: 45, coolDown: 100000),
        ...
        /*            new State("Grave", // Bug
                    ...
                    new State("Attack",
                        ...
                        new State("Shoot1",
                            new Shoot(0, count: 1, defaultAngle: 0, rotateAngle: 30, coolDown: 400, projectileIndex: 1),
                            new Shoot(0, count: 1, defaultAngle: 180, rotateAngle: 30, coolDown: 400, projectileIndex: 1),
