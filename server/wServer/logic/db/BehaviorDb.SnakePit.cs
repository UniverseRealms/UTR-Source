            ...
            .Init("Stheno the Snake Queen",
                new State(
                    ...
                    new State("Silver Blasts",
                        ...
                        new State("Invuln",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable, true, duration: 1000),
                            new TimedTransition(0, "Silver Blasts 1")
                            ),
                        new State("Silver Blasts 1",
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 45, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 1, angleOffset: 135, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0, coolDown: 1001),
                    ...
                    new State("Spawn Stheno Swarm",
                        ...
                        new TimedTransition(16000, "Leave me"),
                        new State("Invuln",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable, true, duration: 1000),
                            new TimedTransition(0, "Silver Blasts Swarm")
                            ),
                        new State("Silver Blasts Swarm",
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 45, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 1, angleOffset: 135, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0, coolDown: 1001),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0, coolDown: 1001),
                    ...
                    new State("Blind Ring Attack + ThrowAttack",
                        ...
                        new State("Blind Ring Attack + ThrowAttack 12",
                            ...
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(500, "Silver Blasts 1")
                        )
                      )
            ),
                    new Threshold(0.01,
                    new ItemLoot("Envenomed Katana", 0.01),
                    new ItemLoot("Snake Oil Poison", 0.01),
                    new ItemLoot("Snake Tooth Shuriken", 0.005),
                    ...
                    new ItemLoot("Scaly Pet Stone", 0.001)
                )
            )
            .Init("Stheno Swarm",
                new State(
            ...
            .Init("Snakepit Button",
                new State(
                    ...
                    new State("Order",
                        ...
                        new SetAltTexture(1),
                        new TimedTransition(200, "I am out")
                    ),
                    new State("I am out")
                )
            )
