...
public class LootboxesDisplayMediator extends Mediator {
    ...
    override public function initialize():void {
        ...
        this.model.lootBox7Changed.add(this.onLootbox7Changed);
    ...
    override public function destroy():void {
        ...
        this.model.lootBox7Changed.remove(this.onLootbox7Changed);
        this.view.openAccountDialog.remove(this.onOpenAccountDialog);
    }

    private function onLootbox1Changed(_arg_1:int):void {
        this.view.draw(this.model.getLootbox1(), this.model.getLootbox2(), this.model.getLootbox3(), this.model.getLootbox4(), this.model.getLootbox7());
    }
    ...
    private function onLootbox7Changed(_arg_1:int):void {
        this.view.draw(this.model.getLootbox1(), this.model.getLootbox2(), this.model.getLootbox3(), this.model.getLootbox4(), this.model.getLootbox7());
    }
